...
dbutils.fs.cp("dbfs:/FileStore/FileStore/Users/konstantina_maria/shampoo_data","/Volumes/dss/imageocr/shampoo_training_data",True)


# COMMAND ----------

dbutils.widgets.text("path", "/Volumes/dss/imageocr/shampoo_training_data/images/delta", "output delta table path")
dbutils.widgets.text("ckpt_path", "/Volumes/dss/imageocr/shampoo_training_data/images/ckpt", "checkpointLocation path")

# COMMAND ----------

dbutils.widgets.text("path", "/dss/imageocr/shampoo_training_data/images_clean", "output delta table path")
dbutils.widgets.text("ckpt_path", "/dss/imageocr/shampoo_images_clean_ckpt", "checkpointLocation path")
...
# MAGIC
# MAGIC ---
# MAGIC * Use [shampoo dataset] hosted under `dbfs:/FileStore/FileStore/Users/konstantina_maria/shampoo_data`.
...
# MAGIC
# MAGIC Location: /Volumes/dss/imageocr/shampoo_data

# COMMAND ----------

# MAGIC %fs ls /Volumes/dss/imageocr/shampoo_data
# MAGIC
...
images = spark.readStream.format("cloudFiles") \
  ...
  .load("/Volumes/dss/imageocr/shampoo_data/")\
  .repartition(4)
...
display_image("/Volumes/dss/imageocr/shampoo_data/back_elvive_color_protecting_sampoo.jpg")
